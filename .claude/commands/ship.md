...
3. Run `git diff` to review the full diff. Draft a concise commit message (1-2 sentences) following the repo's style (`git log --oneline -5`). The message should focus on the "why", not the "what".
